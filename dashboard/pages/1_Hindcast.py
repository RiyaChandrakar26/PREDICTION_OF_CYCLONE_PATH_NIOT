...
# Storm selector
# -----------------------------
# Build storm list ONLY from available observed data
# -----------------------------
...
# -----------------------------
# Observed track (load but DO NOT plot yet)
# -----------------------------
...
# -----------------------------
# Model selector (NO auto plotting)
# -----------------------------
